            ...
            <div>
                <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
                    <div className="container-fluid">
                        <a className="navbar-brand" href="/"> <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVt3ikkCBnxTa1PqFQMRm2AJ6qblH53PkvYQ&usqp=CAU' alt='logo' style={{height:'23px'}}/> Newsapp</a>
                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item"><a className="nav-link" href="/form">Form</a></li>
